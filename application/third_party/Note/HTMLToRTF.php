...
class JoshRibakoff_Note_HTMLToRTF {
   ...
   function convert($text) {
      ...
      $text = str_replace('</p><p>', "\\par\n", $text);
      $text = str_replace('<br>', "\\par", $text);
      ...
      $text = preg_replace('#<ol[^>]*>#', "\\par", $text);
      $text = str_replace('</ol>', '\\par\n', $text);
      
      $text = preg_replace('#<ul[^>]*>#', "\\par", $text);
      $text = str_replace('</ul>', "\\par\n", $text);
      
      $text = preg_replace('#<li[^>]*>#', '\\par\\bullet    ', $text);
      ...
      $text = str_replace($toReplace, $toReplaceWith, $text);
