                ...
                <form action="" id="contribModalID">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group required">
                            ...
                            <select ng-required="true" class="form-control" ng-model="NTF.Contributors.ContributorModal.Role">
                                <option ng-repeat="role in NTF.Contributors.ContributorModal.FixedAuthorRoles" value="{{role.Name}}">{{role.Name}}</option>
                            </select>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="onebtn">
                                                <button class="btn btn-primary pull-right btn-block btn-sm" ng-click="NTF.Contributors.ContributorModal.addAdditionalTitle($index)"><span class="fa fa-plus"></span></button>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr ng-repeat="AdditionalTitles in NTF.Contributors.ContributorModal.AdditionalTitles">
                                            ...
                                            <td>
                                                <button class="btn btn-danger btn-sm" ng-click="NTF.Contributors.ContributorModal.removeAdditionalTitle($index)"><span class="fa fa-minus"></span></button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <div class="checkbox checkbox-primary">
                                <input id="IsTitlePrimary" type="checkbox">
                        ...
                        <div class="col-md-6 form-group">
                            <div class="checkbox checkbox-primary">
                                <input id="IsRolePrimary" type="checkbox" value="1">
