                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <table class="table table-bordered">
                           <thead>
                              <tr>
                                 <th colspan="2" style="text-align: center;">Country(s)</th>

                              </tr>
                              <tr>
                                 <th style="width:50%; text-align: center;">Sell In</th>
                                 <th style="width:50%; text-align: center;">Do Not Sell In</th>
                           ...
                           <tfoot>
                              <tr>
                                 <td colspan="2">
                                    Click the items to move them to their sales lists.
                                 </td>
                              </tr>
                           </tfoot>
                        </table>
