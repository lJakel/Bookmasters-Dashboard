<div style="z-index: 1050; height:100%;" modal-show modal-visible="NTF.Marketing.showReviewDialog" class="modal fade">
   <div class="modal-dialog modal-lg">
      <div class="modal-content" ng-form="ReviewModalForm" ng-repeat="rm in [NTF.Marketing.ReviewModal]">
         ...
         <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" ng-disabled="!ReviewModalForm.$valid" ng-click="NTF.Marketing.onMarketingItemModalAction('Review')">
             Save Review</button>
         </div>
      </div>
      <!-- /.modal-content -->
