         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-6 form-group">
                  ...
                  <input type="text" class="form-control"  ng-model="NTF.Marketing.EndorsementModal.Name">
               </div>
               <div class="col-md-6 form-group">
                  <label for="" class="control-label">Affiliation</label>
                  <input type="text" class="form-control" ng-model="NTF.Marketing.EndorsementModal.Affiliation">
               </div>
            </div>
            <div class="row">
               <div class="col-md-12 form-group">
                  ...
                  <textarea name="" data-summernote id="" cols="30" rows="10" class="form-control" ng-model="NTF.Marketing.EndorsementModal.Text"></textarea>
               </div>
            </div>
         </div>
         <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary" id="save-changes" ng-click="NTF.Marketing.onEndorsementModalAction()">Save changes</button>
         </div>
      </div>
      <!-- /.modal-content -->
   </div>
