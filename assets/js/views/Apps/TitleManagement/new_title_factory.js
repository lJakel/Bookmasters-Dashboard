BMApp.register.factory('FixedReferences', ['$http', '$q', '$state', '$timeout', function ($http, $q, $state, $timeout) {
      var self = this;
      ...
      function loadIsoCodes(get) {
         ...
         return $timeout(function () {
            console.log('simulate post');
         }, 1000).then(function () {

            setIsoCodes(self.isoCodes);
            if (get == true) {
               return factory.isoCodes;
            }
         }, function () {
            factory.isoCodes = null;
            $state.go('error', {
               code: '500',
      ...
      function getIsoCodes() {
         if (typeof (factory.isoCodes) == 'undefined' || factory.isoCodes == null) {
