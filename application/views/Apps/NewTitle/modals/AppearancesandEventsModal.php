<div style="z-index: 999999; height:100%;" modal-show modal-visible="NTF.Marketing.showAppearanceAndEventDialog" class="modal fade"  data-backdrop="static"> 
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-body" ng-repeat="am in [NTF.Marketing.AppearanceAndEventModal]">
            <div class="row">
               <div class="col-md-4 form-group">
                  <label for="" class="control-label">Event Name</label>
                  <input type="text" class="form-control" ng-model="am.Name">
               </div>
               <div class="col-md-4 form-group">
                  ...
                  <input type="text" class="form-control" ng-model="am.Location">
               </div>

               <div class="col-md-4 form-group">
                  <label for="" class="control-label">Date</label>
                  <input type="text" class="form-control" ng-model="am.Date">
               </div>
            </div>
            <div class="row">
               <div class="col-md-12">
                  <label for="" class="control-label">Description</label>
                  <textarea name="" id="" cols="30" data-summernote rows="10" class="form-control" ng-click="am.Text"></textarea>
               </div>
            </div>
         </div>
         <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" ng-click="NTF.Marketing.onMarketingItemModalAction('AppearanceAndEvent')" id="save-changes">Save changes</button>
         </div>
      </div>
      <!-- /.modal-content -->
   </div>
